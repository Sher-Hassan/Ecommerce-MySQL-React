...
export const addProduct = async (req, res) => {
    const { ProductName, Description, Price, CategoryID, Cover } = req.body;
    ...
    try {
        ...
        // Insert the product into the database, including Cover
        await db.promise().query(
            'INSERT INTO Products (ProductName, Description, Price, CategoryID, Cover) VALUES (?, ?, ?, ?, ?)',
            [ProductName, Description, Price, CategoryID, Cover]
        );
...
export const updateProduct = async (req, res) => {
    const { ProductID, ProductName, Description, Price, CategoryID, Cover } = req.body;
    ...
    try {
        ...
        await db.promise().query(
            'UPDATE Products SET ProductName = ?, Description = ?, Price = ?, CategoryID = ?, Cover = ? WHERE ProductID = ?',
            [ProductName, Description, Price, CategoryID, Cover, ProductID]
        );
